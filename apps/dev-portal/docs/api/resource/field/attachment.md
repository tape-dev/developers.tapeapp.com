...
An attachment field can be created as part of an app creation. Here is an example request body for creating an excerpt of a bug-report app within a workspace with ID 1.
