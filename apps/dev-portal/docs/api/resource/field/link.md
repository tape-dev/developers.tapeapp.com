...
`multi_link` field values can hold one or more link entries.
...
A multi_link field can be created as part of an app creation. Here is an example request body for creating an excerpt of a contacts app within a workspace with ID 1.
