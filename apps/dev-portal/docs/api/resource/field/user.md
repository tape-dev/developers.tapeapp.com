...
A user field can be created as part of an app creation. Here is an example request body for creating an excerpt of a meetings app within a workspace with ID 1.
