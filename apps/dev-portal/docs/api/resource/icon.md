...
If you want to set an icon you found on the Material Design Icon Library, you can select the icon, click on "Android" and copy the icon id from the text field.
