...
Currently the following values are allowed as type: `work`, `work_fax`, `home`, `home_fax`, `main`, `mobile`, and `other`. If no type is provided, phone entries always default to `work`.
