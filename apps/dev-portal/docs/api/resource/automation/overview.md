...
An **automation** is one of your workflow automations: a **trigger** that starts it, an optional **filter** that
...
Automations live *above* their executions. Each time an automation fires it produces an
